      ...
      <div className="relative group">
        ...
        {isOwner && hasImage ? (
          <button
            ...
            className={cn(
              "absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-border bg-background p-2 shadow-sm transition",
