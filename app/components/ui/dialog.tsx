...
function DialogOverlay({ className, ...props }: DialogPrimitive.Backdrop.Props) {
	return (
		<DialogPrimitive.Backdrop
			...
			className={cn(
				"data-closed:fade-out-0 data-open:fade-in-0 fixed inset-0 isolate z-50 bg-black/30 duration-100 data-closed:animate-out data-open:animate-in",
				className,
			)}
			{...props}
		/>
...
function DialogFooter({
	...
	return (
		<div data-slot="dialog-footer" className={cn("flex flex-col-reverse gap-2 gap-2 sm:flex-row sm:justify-end", className)} {...props}>
			{children}
