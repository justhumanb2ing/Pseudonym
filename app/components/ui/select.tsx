...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.ItemIndicator render={<span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center"><IconCheck className="pointer-events-none" /></span>} />
    </SelectPrimitive.Item>
  )
}
