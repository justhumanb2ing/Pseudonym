...
import { getStrictContext } from "@/components/ui/get-strict-context";
...
function PopoverPortal(props: PopoverPortalProps) {
	...
	return <AnimatePresence>{isOpen && <PopoverPrimitive.Portal keepMounted data-slot="popover-portal" {...props} />}</AnimatePresence>;
}
