...
const descriptionSchema = z.preprocess(
  ...
  z
    ...
    .max(
      ...
      `Description must be ${PAGE_DESCRIPTION_MAX_LENGTH} characters or less.`
    )
    .nullable()
    .optional()
);
...
export const pageDetailsSchema = z.object({
  ...
  title: z
    ...
    .max(
      ...
      `Title must be ${PAGE_TITLE_MAX_LENGTH} characters or less.`
    ),
 ...
 */
export function normalizePageDetails(
