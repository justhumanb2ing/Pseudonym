...
vi.mock("@/components/ui/drawer", () => ({
	Drawer: ({ children }: { children: ReactNode }) => <div data-slot="drawer">{children}</div>,
	DrawerTrigger: ({ children }: { children: ReactNode }) => <>{children}</>,
	DrawerContent: ({ children }: { children: ReactNode }) => <div data-slot="drawer-content">{children}</div>,
	DrawerHeader: ({ children }: { children: ReactNode }) => <div data-slot="drawer-header">{children}</div>,
	DrawerTitle: ({ children }: { children: ReactNode }) => <div data-slot="drawer-title">{children}</div>,
	DrawerDescription: ({ children }: { children?: ReactNode }) => <div data-slot="drawer-description">{children}</div>,
}));
