/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ef3b902760db6ccbc3d9081ac4d0c410)
// Runtime types generated with workerd@1.20260120.0 2025-04-04 nodejs_compat
...
type = interface DurableObjectState < Props = unknown > {
    waitUntil(promise: Promise<any>): void;
    readonly props: Props;
    readonly id: DurableObjectId;
...
type TraceItemScheduledEventIn = f    readonly scheduledTime: number;
    readonly cron: string;
}
...
declare namespace Cloudflare {
    ...
    //
    typenterf = a// declaration will be merged with this one.
    //
    ...
    typepe of the pro = g// `mainModule` property.
